...
#Transition Finish
execute if score @s wither.animation matches 140 run function wither_rework:wither/phase/2/transition_finish_effects
execute if score @s wither.animation matches 150.. run function wither_rework:wither/phase/2/transition_finish
execute if score @s wither.animation matches 120.. run playsound entity.wither.ambient master @a ~ ~ ~ 0 0 0

#Particles
scoreboard players operation @s wither.ability.int.1 += @s wither.animation

execute unless score @s wither.animation matches 120.. if score @s wither.ability.int.1 matches 250.. run function wither_rework:wither/phase/2/crack_particles
