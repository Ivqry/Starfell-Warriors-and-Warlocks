...
execute unless score @s c.int.0 matches 0 if score .wither_rework.config.WitherGriefing c.int.0 matches 0 run tellraw @s {"text":" Wither Griefing","color":"red"}
...
execute unless score @s c.int.0 matches 0 if score .wither_rework.config.WitherGriefing c.int.0 matches 0 run tellraw @s {"text":" Disabled","color":"red","clickEvent":{"action":"run_command","value":"/function wither_rework:config/wither_griefing/enable"}}
...
execute if score .wither_rework.config.witherFlyFix c.int.0 matches 0 run tellraw @s {"text":" Wither Fly Fix","color":"red"}
...
execute if score .wither_rework.config.witherFlyFix c.int.0 matches 0 run tellraw @s {"text":" Disabled","color":"red","clickEvent":{"action":"run_command","value":"/function wither_rework:config/wither_fly_fix/enable"}}
