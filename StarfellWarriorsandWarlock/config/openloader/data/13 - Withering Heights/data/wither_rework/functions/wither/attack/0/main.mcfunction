...
execute if score @s wither.ability.prep matches 16.. unless score @s wither.ability matches 60.. run function wither_rework:wither/attack/0/action
...
#Reset
execute if entity @s[scores={wither.ability=60..}] run function wither_rework:wither/attack/0/reset
