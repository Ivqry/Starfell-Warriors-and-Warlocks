...
execute if score @s wither.ability.prep matches 41.. unless score @s wither.ability matches 30.. run function wither_rework:wither/attack/1/action
...
#Reset
execute if entity @s[scores={wither.ability=30..}] run function wither_rework:wither/attack/1/reset