...
execute if score cyclestats refresh_count matches 9 run scoreboard objectives setdisplay below_name refresh_player_deaths
execute if score cyclestats refresh_count matches 11 run scoreboard objectives setdisplay below_name refresh_player_d_hours
execute if score cyclestats refresh_count matches 13 run scoreboard objectives setdisplay below_name refresh_player_level
