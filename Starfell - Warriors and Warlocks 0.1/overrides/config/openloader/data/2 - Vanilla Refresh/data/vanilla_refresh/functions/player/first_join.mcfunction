...
execute if score firstjoin refresh_settings matches 1 run tellraw @a [{"translate":"The journey is here. Make it yours...","color":"green","italic":"true"},{"score":{"objective":"refresh_members","name":"@s"}}]
